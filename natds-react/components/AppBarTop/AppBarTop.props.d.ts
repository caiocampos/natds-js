...
declare type AppBarTopColor = 'default' | 'primary' | 'none' | 'inverse';
declare type AppBarTopBehaviour = 'fixed' | 'scroll';
...
export declare type AppBarStyleOptions = AppBarProps & {
    hide: boolean;
};
export {};
