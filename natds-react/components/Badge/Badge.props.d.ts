...
export declare type BadgeColors = keyof Pick<Color, 'primary' | 'secondary' | 'success' | 'alert'>;
...
export declare type BadgePulseProps = BadgeBaseProps & {
    /**
...
export declare type BadgeDotProps = BadgeBaseProps & {
    /**
     * Specify the variant of Badge you want to create.
     * Check each definition [here](https://ds.natura.design/28db352be/p/920945-badge/t/52006b)
     */
...
export declare type BadgeStandardProps = BadgeBaseProps & {
    /**
...
export declare type BadgeProps = BadgePulseProps | BadgeDotProps | BadgeStandardProps;
