...
export declare type IconButtonColors = keyof Pick<Color, 'highEmphasis' | 'primary' | 'surface'>;
export declare type IconButtonSize = keyof Pick<Size, 'semi' | 'medium' | 'semiX'>;
