...
export declare type TagColors = keyof Pick<Color, 'primary' | 'secondary' | 'success' | 'alert' | 'warning' | 'link'>;
export declare type TagSizes = keyof Pick<Size, 'small' | 'standard'>;
export declare type TagPositions = 'center' | 'left' | 'right';
